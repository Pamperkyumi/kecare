import{a as t}from"./DbNIgRzX.js";import{d as r,c as o,o as s}from"./D1LHy2jC.js";import"./anvSD_Ip.js";const m=r({__name:"4ee23999",setup(l){const n={lang:"zh-CN",title:"菜单系统",html:`<div class="kecare"><h1 id="菜单menu">菜单（Menu）</h1>
<div class="md-tabs" data-tabs id="md-tabs-2">
                <div class="md-tabs__nav" role="tablist" aria-label="Code Tabs"><button type="button" role="tab" id="md-tabs-2-tab-0" class="md-tabs__tab" data-tab="0" aria-selected="true" aria-controls="md-tabs-2-panel-0">typescript</button><button type="button" role="tab" id="md-tabs-2-tab-1" class="md-tabs__tab" data-tab="1" aria-selected="false" aria-controls="md-tabs-2-panel-1">javascript</button></div>
                <div class="md-tabs__panels"><div class="md-tabs__panel" role="tabpanel" id="md-tabs-2-panel-0" data-tab="0" aria-labelledby="md-tabs-2-tab-0" aria-hidden="false"><pre><code class="language-python">这是第一个标签页的内容。
- 可以包含 Markdown
- **加粗**、\`代码\`等
</code></pre>
</div>
<div class="md-tabs__panel" role="tabpanel" id="md-tabs-2-panel-1" data-tab="1" aria-labelledby="md-tabs-2-tab-1" aria-hidden="true" hidden><pre><code class="language-javascript">这是第二个标签页的内容。
1. 有序列表
2. 第二个项目
</code></pre>
</div></div>
...
<p>有的人会拿博客来写文档（比如你现在读的这一页捏），通常左侧会有一个菜单栏/目录栏帮助跳转。<br>所以 Kecare 也提供了一套更简单、更统一的菜单编写方式喵~菜单放在哪里？</p>
<h2 id="1-菜单放在哪里喵">1. 菜单放在哪里喵？</h2>
<p>在 Kecare 中，菜单也有<strong>固定存放位置</strong>：</p>
<ul>
<li>菜单目录：<strong>主题目录/.kecare/menus/</strong></li>
</ul>
<blockquote>
<p>✅ 只要放在这个目录里，Kecare 才能扫描到并生成对应的菜单喵~</p>
</blockquote>
<hr>
<h2 id="2-新建菜单文件命名规则很重要捏">2. 新建菜单文件（命名规则很重要捏）</h2>
<p>在菜单目录下新建：<strong><code>*.menu.source.ts</code></strong></p>
<p>例如：</p>
<ul>
...
<blockquote>
<p>文件名前缀（如 <code>kecare-docs</code>）会成为你在文章 Front Matter 里引用的 <strong>menu</strong>，建议用英文 + 短横线更稳定喵~</p>
</blockquote>
<hr>
<h2 id="3-编写菜单内容导出-navitems">3. 编写菜单内容（导出 navItems）</h2>
<h2 id="在菜单文件里导出-navitems类型为-navitem">在菜单文件里导出 <strong>navItems</strong>，类型为 <strong>NavItem[]</strong>：</h2>
...
<h3 id="link-到底是什么"><code>link</code> 到底是什么？</h3>
<p><strong>link</strong> 指的是<strong>要跳转到的文章路径</strong>哦~
一般来说它对应你的文章页面路由（或文章 slug），写成相对形式最常见，例如：</p>
<ul>
<li><code>./快速开始</code></li>
<li><code>./写作</code></li>
</ul>
<h2 id="4-在文章中启用菜单喵">4. 在文章中启用菜单喵</h2>
<p>在需要显示菜单的文章 <strong>.md</strong> 的 Front Matter 里加 <strong>menu</strong>：</p>
...
<p>它对应的菜单文件是：</p>
<ul>
<li><code>主题目录/.kecare/menus/kecare-docs.menu.source.ts</code></li>
</ul>
<blockquote>
<p>✅ 规则总结：<strong>menu</strong> 的值 = <strong>.menu.source.ts</strong> 的文件名前缀捏~</p>
</blockquote>
<hr>
<h2 id="5-navitem-结构说明喵">5. NavItem 结构说明喵</h2>
<p>在 <strong>kecare</strong> 里，<strong>NavItem</strong> 支持两种节点：</p>
<ul>
<li><strong>叶子节点</strong>：可点击跳转（有 <strong>link</strong>）</li>
<li><strong>分组节点</strong>：仅作为分类（有 <strong>items</strong>）</li>
</ul>
<p>类型定义（参考）：</p>
