...
onMounted(() => {
  const doc = document;
  const ipContainer = doc.getElementById("cf-footer-item-ip");
  const revealBtn = doc.getElementById("cf-footer-ip-reveal");

  if (ipContainer && revealBtn) {
    ipContainer.classList.remove("hidden");
    
    const ipElement = doc.getElementById("cf-footer-ip");
    if (ipElement) {
      const handleClick = () => {
        revealBtn.classList.add("hidden");
        ipElement.classList.remove("hidden");
      };
      revealBtn.addEventListener("click", handleClick);
      cleanup = () => revealBtn.removeEventListener("click", handleClick);
    }
  }
});
      ...
      <div id="cf-error-details" class="p-0">
        <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
          ...
          >
            ...
            <span class="code-label">Error code 0721</span>
          </h1>
          <div>
            Visit
            ...
            <div class="clearfix md:px-8">
              ...
              >
                <div class="relative mb-10 md:m-0">
                  ...
                  <span
                    class="cf-icon-ok w-12 h-12 absolute left-1/2 md:left-auto md:right-0 md:top-0 -ml-6 -bottom-4"
                  ></span>
                </div>
              ...
              >
                <div class="relative mb-10 md:m-0">
                  ...
                  <span
                    class="cf-icon-error w-12 h-12 absolute left-1/2 md:left-auto md:right-0 md:top-0 -ml-6 -bottom-4"
                  ></span>
                </div>
                <span class="md:block w-full truncate">Kivotos</span>
                <h3
        ...
        >
          <p class="text-13">
            <span class="cf-footer-item sm:block sm:mb-1"
              >Ray ID: <strong class="font-semibold">{{ error.statusMessage }}</strong></span
            >
            ...
            <span id="cf-footer-item-ip" class="cf-footer-item hidden sm:block sm:mb-1">
              ...
              <span class="hidden" id="cf-footer-ip">我不知道喵~</span>
              <span class="cf-footer-separator sm:hidden">&bull;</span>
            </span>
