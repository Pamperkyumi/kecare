                ...
                const articles = [
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "# 写作 在 Kecare 中，文章有一个固定存放位置喵： - 文章目录：**主题目录/.kecare/articles/** - 文件类型：目前仅支持 **`*.md`** - 推荐命名：使用稳定、可读的英文文件名（例如 **`getti...",
    "hash": "6e8c5f0b",
    "relativePath": "/写作.md",
    "frontMatter": {
  ...
  },
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "# 快速开始 如果你只是想快速体验 Kecare 搭建博客，不打算立刻研究生成器原理或二次开发——照着这篇做就能在本地跑起来捏。 ## 你需要准备什么 ### 必需 - **Node.js**：用于安装主题依赖、启动主题开发服务器（通常是...",
    "hash": "95bb100b",
  ...
  },
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "Kecare 提供了便捷的命令来简化你的开发流程： ### 构建站点 添加主题目录后，直接运行以下命令即可构建站点： ```bash kecare gen ``` 它会自动使用你保存的主题路径进行构建。 ### 启动服务器 启动服务器 ``...",
    "hash": "fddd58bb",
  ...
  },
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "# 菜单（Menu） ::: tabs @tab typescript ```python 这是第一个标签页的内容。 - 可以包含 Markdown - **加粗**、`代码`等 ``` @tab javascript ```javascr...",
    "hash": "4ee23999",
  ...
  },
  {
    ...
    "cover": "https://pichost.cloud/files/944b71a32407dd671f9d09296c439efb3cfeb95341fd87cc9490470710bbbc76.webp",
    "__REAL_FS_PATHS__": "C:\\Users\\Pamper\\Desktop\\workspace\\Kecare\\projects\\theme\\app\\pages\\articles\\zh-CN\\9e192d60.vue",
    "__REAL_RELATIVE_PATHS__": "articles/zh-CN/9e192d60",
    "fsPath": "C:\\Users\\Pamper\\Desktop\\workspace\\Kecare\\projects\\theme\\app\\pages\\articles\\zh-CN\\9e192d60.vue",
    "urlPath": "articles/zh-CN/9e192d60"
  }
]
                const currentPage = 2
                const totalPages = 3
