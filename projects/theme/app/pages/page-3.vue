                ...
                const articles = [
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "写作 在 Kecare 中，文章有固定的存放位置和格式规范。本文档将教你如何创建和编写文章。 文章存放位置 在 Kecare 中，文章统一存放在以下目录： | 项目 | 说明 | |------|------| | 目录位置 | 主题目录/...",
    "hash": "6e8c5f0b",
    "relativePath": "/写作.md",
    "frontMatter": {
  ...
  },
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "生成器 CLI Kecare 提供了便捷的命令行工具来简化你的开发流程。本文档介绍所有可用的 CLI 命令。 命令概览 | 命令 | 说明 | |------|------| | kecare gen [path] | 构建站点，生成页面文...",
    "hash": "fddd58bb",
  ...
  },
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "国际化处理 每一篇用心撰写的文章都值得被更多人看见，值得跨越语言的界限，被全世界的读者阅读。Kecare 为你提供了强大的国际化（i18n）支持，让你的内容能够轻松触达全球受众。 为什么需要国际化 扩大受众范围 触达不同语言背景的读者 提升...",
    "hash": "493f5fa2",
  ...
  },
  {
    ...
    "isOriginalLang": true,
    "menu": "test",
    "desc": "贡献指南 感谢你对 Kecare 项目的关注！ 懒了喵，以后写 致谢 感谢所有为 Kecare 做出贡献的开发者！ 你的每一份贡献都让这个项目变得更好。 贡献流程： Fork 项目 创建分支 进行修改 提交 PR 等待审核 我们期待你的贡献...",
    "hash": "43fc313b",
