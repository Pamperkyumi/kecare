export async function onMountedCopy(articleElement: HTMLDivElement, hash?: string, path?: string, basePath: string = '/articles') {
    ...
    copyButton.addEventListener('click', async () => {
        try {
            ...
            const jsonPath = `${basePath.replace(/\/$/, '')}/${hash}.${lang}.json`;
